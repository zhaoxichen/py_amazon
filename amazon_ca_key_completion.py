...
if __name__ == "__main__":
    # 第一步：先把amazon主页拉下来
    resp = requests.get("https://www.amazon.ca/ref=nav_logo", headers=unicornHeader)
    respText = resp.text
    ...
    while 1:
        ...
        # https://completion.amazon.com/search/complete?method=completion&mkt=7&r=MCDQ2E39H2C182CM74N1&s=135-9647165-5161406&c=&p=Gateway&l=en_CA&b2b=0&fresh=0&sv=desktop&client=amazon-search-ui&x=String&search-alias=aps&ks=8&q=do&qs=&cf=1&fb=1&sc=1&
        keywordsUrl = f'https://completion.amazon.com/search/complete?method=completion&mkt=7&r={ue_id}&s={ue_sid}c=&p=Gateway&l=en_CA&b2b=0&fresh=0&sv=desktop&client=amazon-search-ui&x=String&search-alias={search_alias}&ks={ks}&q={originalKey}&qs=&cf=1&fb=1&sc=1&'
